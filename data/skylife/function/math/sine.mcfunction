...
#> Run (function placeholder:math/sine with storage skylife:math in)
...
data modify storage skylife:math out set from entity 00000000-0000-0000-0000-000000000010 Pos[0]